...
function Main() {
  ...
  return(
    <div className="body__wrapper">
      ...
      <div className="header__nav-case">
        <button tabIndex="1" className="header__menu display-tablet" onClick={() => setModalBurgerActive(true)}></button>
        <picture>
          <img src="./image/logo-mobile.png" className="header__img" alt="логотип ЛигаБанк" width="119" height="19" />
        </picture>
    ...
    <footer className="page-footer">
      <section className="footer-description">
        ...
        <div className="footer-description__wrapper">
          <div className="foother-description__container">
            <div className="adress">
              <a href="/" className="adress__logo">
                <picture>
                  <img src="./image/logo-mobile.png" className="adress__img" alt="logoLiga" />
                </picture>
              </a>
            </div>
          ...
          <div className="foother-description__case">
            ...
            <div className="social">
              <ul className="social__list">
                <li className="social__item">
                  <a href="https://www.facebook.com/" aria-label="Facebook" className="sociai__icon">
                ...
                <li className="social__item">
                  <a href="https://www.instagram.com/" aria-label="Instagram" className="sociai__icon">
                ...
                <li className="social__item">
                  <a href="https://www.twitter.com" aria-label="Twitter" className="sociai__icon">
                ...
                <li className="social__item">
                  <a href="https://www.youtube.com" aria-label="Youtube" className="sociai__icon"> 
                    <svg width="16" height="13" viewBox="0 0 16 13" fill="none" xmlns="http://www.w3.org/2000/svg">
